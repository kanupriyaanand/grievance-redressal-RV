...
def register3(request):
    ...
    context={'form': form,'profile_form':profile_form }
    return render(request, 'GRsystem/register3.html',context )    
...
def complaints(request):
    ...
    if request.method == 'POST':
        ...
        if complaint_form.is_valid():
               ...
               send_mail(message,name,'settings.EMAIL_HOST_USER',[email],fail_silently=False)
               instance.save()
...
def allcomplaints(request):
        ...
        if date:
                c=c.filter(Q(Time__icontains=date))        
        if request.method=='POST':
...
def pdf_viewer(request):
    ...
    print (delta.days )       
    if detailtype=='1':
            detailtype="Type of Complaint: Academics"
    if detailtype=='3':
            detailtype="Type of Complaint: Infrastructure/Cleanliness"
    if detailtype=='2':
            detailtype="Type of Complaint: SAP"
    if detailtype=='4':
            detailtype="Type of Complaint: Social"
    if detailtype=='5':
            detailtype="Type of Complaint: Others"
...
def pdf_view(request):
    ...
    if detailtype=='4':
            detailtype="Type of Complaint: Social"
    if detailtype=='5':
            detailtype="Type of Complaint: Othera"
