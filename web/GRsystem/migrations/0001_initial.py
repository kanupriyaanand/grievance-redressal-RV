    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('Type_of_complaint', models.CharField(choices=[('Academics', 'Academics'), ('SAP', 'SAP'), ('Infrastructure/Cleanliness', 'Infrastructure/Cleanliness'), ('Social', 'Social'), ('Othesr', 'Others')], max_length=200, null=True)),
