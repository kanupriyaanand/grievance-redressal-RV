...
urlpatterns=[
    ...
    url(r'^register2/$', views.register, name='register2'),
    ...
    url(r'^signinstaff/$',auth_views.LoginView.as_view(template_name='GRsystem/signinstaff.html'), name='signinstaff'),
    url(r'^signin2/$',auth_views.LoginView.as_view(template_name='GRsystem/signin2.html'), name='signin2'),
    url(r'^profile/$',auth_views.LoginView.as_view(template_name='GRsystem/profile.html'), name='profile'),
    url(r'^profilestaff/$',auth_views.LoginView.as_view(template_name='GRsystem/profile.html'), name='profilestaff'),
