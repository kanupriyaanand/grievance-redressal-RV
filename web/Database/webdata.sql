...
CREATE TABLE IF NOT EXISTS `auth_user` (
  ...
  'ward_mail' varchar(254) DEFAULT NULL,
...
INSERT INTO `auth_user` (`id`, `password`, `last_login`, `is_superuser`, `username`, `first_name`, 'ward_name', 'ward_mail', `last_name`, `email`, `is_staff`, `is_active`, `date_joined`) VALUES
...
DROP TABLE IF EXISTS `auth_parent`;
CREATE TABLE IF NOT EXISTS `auth_parent` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `password` varchar(128) NOT NULL,
  `last_login` datetime(6) DEFAULT NULL,
  `is_superuser` tinyint(1) NOT NULL,
